...
if (argc!=6)  //adresse IP et numéro de port, nom du joueur,
{
  ...
  strcpy(mainServerAddr,argv[1]);//on recopie les arg1 dans les mainserver etc..
  ...
  server_thread_ret = pthread_create( &server_thread, NULL, server_func, NULL); // dans mon appli joueur j'ai un fil d'éxecution et une activité qui represente un serveur TCP
